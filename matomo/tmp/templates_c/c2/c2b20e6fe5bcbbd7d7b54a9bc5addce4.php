...
class __TwigTemplate_2e06d261b86f701293938092ec4a7fa0 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("<br />{{ 'GeoIp2_GeoIPVariablesConfigurationHere'|translate('<a href=\"' ~ configUrl|e('html_attr') ~ '\">', '</a>')|raw }}", "@GeoIp2/serverModule.twig", "/var/www/matomo/plugins/GeoIp2/templates/serverModule.twig");
    }
}
