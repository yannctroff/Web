...
class __TwigTemplate_e4116f5f87d6ef6013863e1e9790bdb0 extends Template
{
    private $source;
    private $macros = [];
...
{{ 'Actions_ColumnSearchResultsCount'|translate }}: {{ action.siteSearchCount|rawSafeDecoded }}{% endif %}", "@Live/_actionTooltip.twig", "/var/www/matomo/plugins/Live/templates/_actionTooltip.twig");
    }
}
