...
class __TwigTemplate_76342d1db7e004e17a052e17f07b3fa3 extends Template
{
    private $source;
    private $macros = [];
...
{% for visitor in dataTable.getRows() %}
    ...
    {{ visitorRow }}
{% endfor %}
", "@Live/_dataTableViz_visitorLog.twig", "/var/www/matomo/plugins/Live/templates/_dataTableViz_visitorLog.twig");
    }
}
