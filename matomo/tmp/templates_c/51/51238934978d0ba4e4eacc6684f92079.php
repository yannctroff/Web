...
class __TwigTemplate_4eca552941305762ad2982247a5effea extends Template
{
    private $source;
    private $macros = [];
...
{% endfor %}", "@SitesManager/_othersTab.twig", "/var/www/matomo/plugins/SitesManager/templates/_othersTab.twig");
    }
}
