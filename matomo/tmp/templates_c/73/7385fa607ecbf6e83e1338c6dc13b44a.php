...
/* @Login/login.twig */
class __TwigTemplate_bc1777d9919a07771564ebe6592134e0 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_loginContent($context, array $blocks = [])
    {
        ...
        ";
        // line 6
        yield from         $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 6, "1776961983")->unwrap()->yield(CoreExtension::merge($context, ["title" => $this->env->getFilter('translate')->getCallable()("Login_LogIn")]));
        // line 74
        yield "    </div>
    <div class=\"contentForm resetForm\" style=\"display:none;\">
        ";
        // line 76
        yield from         $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 76, "1023284754")->unwrap()->yield(CoreExtension::merge($context, ["title" => $this->env->getFilter('translate')->getCallable()("Login_ChangeYourPassword")]));
        // line 131
        yield "    </div>
...
{% endblock %}", "@Login/login.twig", "/var/www/matomo/plugins/Login/templates/login.twig");
    }
}


/* @Login/login.twig */
class __TwigTemplate_bc1777d9919a07771564ebe6592134e0___1776961983 extends Template
{
    private $source;
    private $macros = [];
...
/* @Login/login.twig */
class __TwigTemplate_bc1777d9919a07771564ebe6592134e0___1023284754 extends Template
{
    private $source;
    private $macros = [];
