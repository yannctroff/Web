...
class __TwigTemplate_df1326a4f2a8338a67887871545a0136 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("<div vue-entry=\"Feedback.FeedbackQuestion\" show-question-banner=\"{{ (showQuestionBanner == 1)|json_encode }}\"></div>", "@Feedback/feedbackQuestionBanner.twig", "/var/www/matomo/plugins/Feedback/templates/feedbackQuestionBanner.twig");
    }
}
